      ...
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
        <div className="flex flex-col md:flex-row items-start">
          ...
          <div className="md:w-1/2 md:ml-12 flex flex-col items-start">
            ...
            <div className="mb-8">
              <p className="text-gray-700 font-semibold mb-3">Color:</p>
            ...
            <div className="mb-6 items-start">
              ...
              <div className="flex items-center space-x-4 mt-2">
                <button
                  ...
                  className="px-3 py-1 bg-[#F8EDEB] text-[#B76E79] rounded-md text-lg hover:bg-[#E8CFCB] transition"
                >
                  -
                </button>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <button
                ...
                className={`flex-1 bg-[#B76E79] text-white py-3 px-6 rounded-lg ${
                  isButtonDisabled
                    ...
                    : "hover:bg-[#A85C65] transition duration-300 shadow-sm"
                }`}
              >
              ...
              <div className="relative group">
                <button
                  ...
                  className={`flex items-center justify-center px-4 py-3 rounded-lg border border-[#B76E79] hover:bg-[#F8EDEB] transition ${isWishlisted ? "text-white bg-[#B76E79]" : "text-[#B76E79]"}`}
                >
                  ❤
                </button>
            ...
            <div className="border-t pt-4 mt-4">
              <div className="mt-4 space-y-2">
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <span className="ml-1 font-medium">8–12 days</span>
                </div>

                <div className="flex items-center text-sm text-gray-600">
                  <FiPackage className="text-[#B76E79] mr-2" />
                  High delivery time due to{" "}
                  <span className="ml-1 font-medium">handmade products</span>
                </div>
              </div>
            </div>
          </div>
