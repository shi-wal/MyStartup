...
const CartDrawer = ({drawerOpen, toggleCartDrawer}) => {
  ...
  return (
    ...
    drawerOpen? "translate-x-0": "translate-x-full"}`}> 
        ...
        {/* cart content with scrollable property */}
        ...
        <div className='p-4 bg-white sticky bottom-0'>
            <button onClick={handleCheckout} className='w-full bg-gray-600 text-white py-3 rounded-lg font-semibold hover:bg-black transition'>Checkout</button>
